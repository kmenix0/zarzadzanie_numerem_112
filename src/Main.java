...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        reports[0][1] = new String[] {"Widzę palący się samochód, wydaje się, że nikogo w nim nie ma", "Z jednego z domków jednorodzinnych wydobywa się dym", "Proszę tu kogoś przysłać, właśnie doszło do wybuchu butli gazowej", "Palą się dwa śmietniki, takie większe - kontenerowe"}; // 4

        reports[1][0] = new String[] {"Pogotowie Ratunkowe"};
        reports[1][1] = new String[] {"Tutaj leży nieprzytomna kobieta", "Facet stracił przytomność, nie reaguje", "Jakieś dziecko ma trudności z oddychaniem, wydaje się być w poważnym stanie", "Mam tutaj rannego chłopaka, po upadku, nie może wstać", "Ból w klatce piersiowej, osoba wygląda na bardzo osłabioną"}; // 5

        reports[2][0] = new String[] {"Policja"};
        reports[2][1] = new String[] {"Ktoś ukradł właśnie moją walizke, mam tam bardzo cenne przedmioty", "Pracuje w ochronie, jeden z przechodniów poinformował mnie, że widział jak jakiś dziwny chłopak zostawił pod ławką plecak. Na pewno specjalnie", "Jakiś idiota próbował, ukraść mój rower. Potrzebny patrol", "Widzę grupke osób z kijami bejsbolowymi, którzy idą środkiem drogi"}; // 4
        ...
        reports[4][1] = new String[] {"Niedaleko mojego mieszkania jakaś dziewczyna najpierw krzyczała, a teraz trzyma w ręku butelke i zapalniczke. Wygląda jakby krzyczatała do któregoś z okien", "Lokalni huligani podpalili kiosk. Uciekli za blok nr 2"}; // 2

        reports[5][0] = new String[] {"Straż Pożarna i Pogotowie Ratunkowe"};
        reports[5][1] = new String[] {"Doszło do wypadku, na drodze powiatowej nr 72. Jeden samochód leży na boku, w drugim jest nieprzytomny mężczyzna", "Wypadek z dużymi uszkodzeniami, w okolicy czuję spaleniznę"}; // 2
